...
void DrawTom::Create(DX::DeviceResources* pDR)
{
	...
	// 座標の初期化
	m_defaultPos[0] = SimpleMath::Vector3{ 0.0f,0.0f,0.0f };	 // 左上
	m_defaultPos[1] = SimpleMath::Vector3{ 0.0f,0.0f,0.0f };	 // 右上
	m_defaultPos[2] = SimpleMath::Vector3{ 0.0f,0.0f,0.0f };	 // 左下
	m_defaultPos[3] = SimpleMath::Vector3{ 0.0f,0.0f,0.0f };	 // 右下
}
...
void DrawTom::Render(DirectX::SimpleMath::Matrix view, DirectX::SimpleMath::Matrix proj)
{
	...
	//{
	//	VertexPositionColorTexture(m_defaultPos[0], SimpleMath::Vector4::One, SimpleMath::Vector2(0.0f, 0.0f)),	// 左上
	//	VertexPositionColorTexture(m_defaultPos[1], SimpleMath::Vector4::One, SimpleMath::Vector2(1.0f, 0.0f)),	// 右上
	//	VertexPositionColorTexture(m_defaultPos[2], SimpleMath::Vector4::One, SimpleMath::Vector2(0.0f, 1.0f)),	// 左下
	//	VertexPositionColorTexture(m_defaultPos[3], SimpleMath::Vector4::One, SimpleMath::Vector2(1.0f, 1.0f)),	// 右下
	//};
	// 頂点情報(板ポリゴンの１頂点の座標情報）
